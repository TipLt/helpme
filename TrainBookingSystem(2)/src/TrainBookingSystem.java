...
public class TrainBookingSystem {
    ...
    private static void displayMainMenu() {
        ...
        System.out.println("1.2. Input & Insert Train data");
        ...
        System.out.println("1.6. Search Train by tcode");
        System.out.println("1.7. Delete Train by tcode");
        System.out.println("1.8. Simply Balancing the BST");
        System.out.println("1.9. Count Number of Trains");
        System.out.println("\nCustomer List:");
        System.out.println("2.1. Load Customer Data from file");
        System.out.println("2.2. Input & Add Customer");
        System.out.println("2.3. Display Customer Data");
        System.out.println("2.4. Save Customer Data to file");
        System.out.println("2.5. Search Customer by ccode");
        System.out.println("2.6. Delete Customer by ccode");
        System.out.println("\nBooking List:");
        System.out.println("3.1. Input Booking Data");
        System.out.println("3.2. Display Booking Data");
        System.out.println("3.3. Sort Booking List");
    ...
    private static void processTrainMenu() {
        System.out.println("\n--- Train Menu ---");
        System.out.println("1.1. Load data from file (train.txt)");
        System.out.println("1.2. Input & insert data");
        System.out.println("1.3. In-order traverse");
        System.out.println("1.4. Breadth-first traverse");
        System.out.println("1.5. In-order traverse to file (train_out.txt)");
        System.out.println("1.6. Search by tcode");
        System.out.println("1.7. Delete by tcode");
        System.out.println("1.8. Simply balancing");
        System.out.println("1.9. Count number of trains");
        System.out.print("Select option (1.1 to 1.9): ");
    ...
    private static void processCustomerMenu() {
        System.out.println("\n--- Customer Menu ---");
        System.out.println("2.1. Load data from file (customer.txt)");
        System.out.println("2.2. Input & add customer");
        System.out.println("2.3. Display customer data");
        System.out.println("2.4. Save customer data to file (customer_out.txt)");
        System.out.println("2.5. Search customer by ccode");
        System.out.println("2.6. Delete customer by ccode");
        System.out.print("Select option (2.1 to 2.6): ");
        String opt = sc.nextLine();
    ...
    private static void processBookingMenu() {
        ...
        System.out.println("3.1. Input booking data");
        System.out.println("3.2. Display booking data");
        System.out.println("3.3. Sort booking list (by train code and customer code)");
        System.out.print("Select option (3.1 to 3.3): ");
        String opt = sc.nextLine();
